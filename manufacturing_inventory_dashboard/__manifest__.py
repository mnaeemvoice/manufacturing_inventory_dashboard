{
    ...
    'description': 'A comprehensive Odoo dashboard module designed to provide real-time insights into manufacturing operations and inventory levels. Features include real-time KPIs, interactive charts, date range filtering, drill-down functionality, dark mode toggle, CSV export, user customization, and live data tables.',
